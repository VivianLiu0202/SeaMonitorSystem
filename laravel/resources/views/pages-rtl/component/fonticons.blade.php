<x-rtl.base-layout :scrollspy="true">
    ...
    <x-slot:headerFiles>
        ...
        @vite(['resources/rtl/scss/light/assets/components/font-icons.scss'])
        @vite(['resources/rtl/scss/dark/assets/components/font-icons.scss'])
...
&lt;i class="far fa-address-book"&gt;&lt;/i&gt;
    ...
    <x-slot:footerFiles>
        ...
        <script type="module" src="{{asset('plugins-rtl/font-icons/feather/feather.min.js')}}"></script>
