<x-rtl.base-layout :scrollspy="false">
    ...
    <x-slot:headerFiles>
        ...
        @vite(['resources/rtl/scss/light/assets/apps/invoice-preview.scss'])
        @vite(['resources/rtl/scss/dark/assets/apps/invoice-preview.scss'])
    ...
    <x-slot:footerFiles>
        @vite(['resources/rtl/assets/js/apps/invoice-preview.js'])
    </x-slot>
