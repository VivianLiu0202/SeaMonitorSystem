<x-rtl.base-layout :scrollspy="false">
    ...
    <x-slot:headerFiles>
        ...
        @vite(['resources/rtl/scss/light/assets/apps/contacts.scss'])

        @vite(['resources/rtl/scss/dark/assets/components/modal.scss'])
        @vite(['resources/rtl/scss/dark/assets/apps/contacts.scss'])
    ...
    <x-slot:footerFiles>
        ...
        @vite(['resources/rtl/assets/js/apps/contact.js'])
    </x-slot>
