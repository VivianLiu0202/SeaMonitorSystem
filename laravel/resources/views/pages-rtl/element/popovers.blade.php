<x-rtl.base-layout :scrollspy="true">
    ...
    <x-slot:headerFiles>
        ...
        @vite(['resources/rtl/scss/light/assets/elements/popover.scss', 'resources/rtl/scss/dark/assets/elements/popover.scss'])
...
content: "Primary popover"
    ...
    <x-slot:footerFiles>
        @vite(['resources/rtl/assets/js/elements/popovers.js'])
    </x-slot>
