<x-rtl.base-layout :scrollspy="true">
    ...
    <x-slot:headerFiles>
        ...
        @vite(['resources/rtl/scss/light/assets/elements/search.scss', 'resources/rtl/scss/dark/assets/elements/search.scss'])
...
&lt;/div&gt;
    ...
    <x-slot:footerFiles>
        ...
        @vite(['resources/rtl/assets/js/elements/custom-search.js'])
    </x-slot>
