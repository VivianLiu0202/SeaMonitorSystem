<x-rtl.base-layout :scrollspy="true">
    ...
    <x-slot:headerFiles>
        ...
        @vite(['resources/rtl/scss/light/assets/elements/custom-typography.scss', 'resources/scss/dark/assets/elements/custom-typography.scss'])
                            ...
                            <blockquote class="blockquote media-object">
                                <div class="media">
                                    <div class="usr-img me-2">
                                        <img alt="avatar" src="{{Vite::asset('resources/images/profile-16.jpeg')}}" class="br-30">
                                    </div>
