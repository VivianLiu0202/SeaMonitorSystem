...
placement:"bottom",
    ...
    <x-slot:footerFiles>
        ...
        <script src="{{asset('plugins-rtl/bootstrap-maxlength/bootstrap-maxlength.js')}}"></script>
        <script src="{{asset('plugins-rtl/bootstrap-maxlength/custom-bs-maxlength.js')}}"></script>
    </x-slot>
