<x-rtl.base-layout :scrollspy="true">
    ...
    <x-slot:headerFiles>
        ...
        <link rel="stylesheet" type="text/css" href="{{asset('plugins-rtl/bootstrap-touchspin/jquery.bootstrap-touchspin.min.css')}}">
        @vite(['resources/rtl/scss/light/plugins/bootstrap-touchspin/custom-jquery.bootstrap-touchspin.min.scss'])
...
buttonup_class: "btn btn-classic btn-success"
    ...
    <x-slot:footerFiles>
        ...
        <script src="{{asset('plugins-rtl/bootstrap-touchspin/custom-bootstrap-touchspin.js')}}"></script>
    </x-slot>
