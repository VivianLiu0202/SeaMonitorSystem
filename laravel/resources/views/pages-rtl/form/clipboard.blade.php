<x-rtl.base-layout :scrollspy="true">
    ...
    <x-slot:headerFiles>
        ...
        @vite(['resources/rtl/scss/light/plugins/clipboard/custom-clipboard.scss'])
        @vite(['resources/rtl/scss/dark/plugins/clipboard/custom-clipboard.scss'])
...
&lt;/div&gt;
    ...
    <x-slot:footerFiles>
        <script src="{{asset('plugins-rtl/clipboard/clipboard.min.js')}}"></script>
        <script type="module" src="{{asset('plugins-rtl/clipboard/custom-clipboard.min.js')}}"></script>
    </x-slot>
