<x-rtl.base-layout :scrollspy="true">
    ...
    <x-slot:headerFiles>
        ...
        @vite(['resources/rtl/scss/light/plugins/editors/markdown/simplemde.min.scss'])
        @vite(['resources/rtl/scss/dark/plugins/editors/markdown/simplemde.min.scss'])
...
unique_id: "demo2",
    ...
    <x-slot:footerFiles>
        <script type="module" src="{{asset('plugins-rtl/editors/markdown/simplemde.min.js')}}"></script>
        <script type="module" src="{{asset('plugins-rtl/editors/markdown/custom-markdown.js')}}"></script>
    </x-slot>
