<x-rtl.base-layout :scrollspy="true">
    ...
    <x-slot:headerFiles>
        ...
        <link rel="stylesheet" href="{{asset('plugins-rtl/stepper/bsStepper.min.css')}}">
        @vite(['resources/rtl/scss/light/plugins/stepper/custom-bsStepper.scss'])
        @vite(['resources/rtl/scss/dark/plugins/stepper/custom-bsStepper.scss'])
    ...
    <x-slot:footerFiles>
        <script src="{{asset('plugins-rtl/stepper/bsStepper.min.js')}}"></script>
        <script src="{{asset('plugins-rtl/stepper/custom-bsStepper.min.js')}}"></script>
    </x-slot>
